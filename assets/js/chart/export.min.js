    ...
    AmCharts["export"] = function (t, r) {
        var s, d = {
            ...
            drawing: {
                ...
                handler: {
                    undo: function () {
                        ...
                        var u = d.deepMerge({top: d.setup.fabric.height / 2, left: d.setup.fabric.width / 2}, c || {}),
                            f = -1 == u.url.indexOf(".svg") ? fabric.Image.fromURL : fabric.loadSVGFromURL;
                        f(u.url, function (h, m) {
                            var w = void 0 === m ? h : fabric.util.groupSVGElements(h, m), N = !1;
                        ...
                        var m, w, N, h = d.deepMerge({}, c || {}), S = f || d.drawing.buffer.target,
                        ...
                        var f, h, m, w, u = d.deepMerge({
                            ...
                            group: []
                        }, c || {}), N = new fabric.Line([u.x1, u.y1, u.x2, u.y2], {
                            stroke: u.color,
                            strokeWidth: u.width,
            ...
            download: function (c, u, f) {
                if (window.saveAs && d.setup.hasBlob) d.toBlob({data: c, type: u}, function (T) {
                    saveAs(T, f)
                    ...
                    var m = document.createElement("div"), w = document.createElement("div"), S = d.toImage({data: c});
            ...
            loadResource: function (c, u) {
                ...
                for (-1 == c.indexOf(".js") ? -1 != c.indexOf(".css") && (N = document.createElement("link"), N.setAttribute("type", "text/css"), N.setAttribute("rel", "stylesheet"), N.setAttribute("href", M)) : (N = document.createElement("script"), N.setAttribute("type", "text/javascript"), N.setAttribute("src", M), d.libs.async && N.setAttribute("async", "")), m = 0; m < document.head.childNodes.length; m++) if (S = document.head.childNodes[m], T = !!S && (S.src || S.href), A = !!S && S.tagName, S && T && -1 != T.indexOf(c)) {
                    d.libs.reload && document.head.removeChild(S), w = !0;
                    break
                }
                Object.keys(d.libs.namespaces).some(function (F) {
                    var D = d.libs.namespaces[F], E = c.toLowerCase(), I = F.toLowerCase();
                    if (-1 != E.indexOf(I)) {
            ...
            loadDependencies: function () {
                var c;
                if (d.libs.autoLoad) for (c = 0; c < d.libs.resources.length; c++) d.libs.resources[c] instanceof Object ? Object.keys(d.libs.resources[c]).some(function (f) {
            ...
            deepMerge: function (c, u, f) {
                ...
                return c instanceof Object || c instanceof Array ? (Object.keys(u).some(function (N) {
                    return "array" == w && isNaN(N) ? !1 : void(m = u[N], (c && void 0 == c[N] || f) && (m instanceof Array ? c[N] = [] : m instanceof Function ? c[N] = function () {
                    } : m instanceof Date ? c[N] = new Date : m instanceof Object ? c[N] = {} : m instanceof Number ? c[N] = new Number : m instanceof String && (c[N] = new String)), (m instanceof Object || m instanceof Array) && !(m instanceof Function || m instanceof Date || d.isElement(m)) && "chart" != N && "scope" != N ? d.deepMerge(c[N], m, f) : c instanceof Array && !f ? c.push(m) : c && (c[N] = m))
                }), c) : c
            },
            ...
            gatherElements: function (c, u, f) {
                ...
                for (h = 0; h < c.children.length; h++) {
                    ...
                    if ("clipPath" == w.tagName) {
                        var N = {}, S = fabric.parseTransformAttribute(d.gatherAttribute(w, "transform"));
                        ...
                        for (m = 0; m < w.childNodes.length; m++) if ("rect" == w.childNodes[m].tagName) T.fill = w.childNodes[m].getAttribute("fill"); else if ("image" == w.childNodes[m].tagName) {
                        ...
                        for (m = 0; m < A.length; m++) {
                            var M = A[m], F = w.getAttribute(M), D = d.getRGBA(F), E = d.isHashbanged(F);
            ...
            gatherPosition: function (c, u) {
                var m, f = d.drawing.buffer.position, h = fabric.util.invertTransform(d.setup.fabric.viewportTransform);
            ...
            modifyFabric: function () {
                fabric.ElementsParser.prototype.resolveGradient = function (c, u) {
                    ...
                    var h = "", m = [];
                    if (!("textContent" in c)) "firstChild" in c && null !== c.firstChild && "data" in c.firstChild && null !== c.firstChild.data && m.push(c.firstChild.data); else if (c.childNodes) for (var w = 0; w < c.childNodes.length; w++) m.push(c.childNodes[w].textContent); else m.push(c.textContent);
                    h = m.join("\n");
                    var N = new fabric.Text(h, u), S = 0;
            ...
            capture: function (c, u) {
                var f, h = d.deepMerge(d.deepMerge({}, d.config.fabric), c || {}), m = [], w = {
                    x: 0,
                    y: 0,
                    pX: 0,
                    pY: 0,
                ...
                }, N = {loaded: 0, included: 0}, S = {items: [], width: 0, height: 0, maxWidth: 0, maxHeight: 0};
                ...
                if (d.config.legend) {
                    if ("stock" == d.setup.chart.type) for (f = 0; f < d.setup.chart.panels.length; f++) d.setup.chart.panels[f].stockLegend && d.setup.chart.panels[f].stockLegend.divId && S.items.push(d.setup.chart.panels[f].stockLegend); else d.setup.chart.legend && d.setup.chart.legend.divId && S.items.push(d.setup.chart.legend);
                ...
                for (d.setup.fabric = new fabric.Canvas(d.setup.canvas, D), d.deepMerge(d.setup.fabric, h), d.deepMerge(d.setup.fabric.freeDrawingBrush, h.drawing), d.deepMerge(d.drawing, h.drawing), d.drawing.handler.change(h.drawing), d.setup.fabric.on("mouse:down", function (E) {
                    ...
                    var I = E.target, P = d.deepMerge(d.getState(I), {
                        cfg: {
                            color: d.drawing.color,
                            width: d.drawing.width,
                    ...
                    var I = E.target;
                    console.log(I);
                    var P = JSON.parse(I.recentState), O = d.deepMerge(d.getState(I), {cfg: P.cfg});
                    ...
                    "stock" == d.setup.chart.type && d.setup.chart.legendSettings.position ? -1 == ["top", "bottom"].indexOf(d.setup.chart.legendSettings.position) ? -1 != ["left", "right"].indexOf(d.setup.chart.legendSettings.position) && (A.offset.y = d.pxToNumber(A.parent.style.top) + w.pY, A.offset.x = d.pxToNumber(A.parent.style.left) + w.pX, A.has.legend ? w.pY += d.pxToNumber(A.has.panel.style.height) + d.setup.chart.panelsSettings.panelSpacing : A.has.scrollbar && (A.offset.y -= d.setup.chart.panelsSettings.panelSpacing)) : A.parent.style.top && A.parent.style.left ? (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left)) : (A.offset.x = w.x, A.offset.y = w.y, w.y += d.pxToNumber(A.parent.style.height), A.has.panel ? (w.pY = d.pxToNumber(A.has.panel.style.marginTop), A.offset.y += w.pY) : A.has.scrollbar && (A.offset.y += w.pY)) : ("absolute" == A.parent.style.position ? (A.offset.absolute = !0, A.offset.top = d.pxToNumber(A.parent.style.top), A.offset.right = d.pxToNumber(A.parent.style.right, !0), A.offset.bottom = d.pxToNumber(A.parent.style.bottom, !0), A.offset.left = d.pxToNumber(A.parent.style.left), A.offset.width = d.pxToNumber(A.parent.style.width), A.offset.height = d.pxToNumber(A.parent.style.height)) : A.parent.style.top && A.parent.style.left ? (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left)) : A.legend ? ("left" == A.legend.position ? w.x = S.maxWidth : "right" == A.legend.position ? A.offset.x = w.width - S.maxWidth : "top" == A.legend.position ? w.y += A.legend.height : "bottom" == A.legend.position && (A.offset.y = w.height - S.height), A.offset.y += w.lY, w.lY += A.legend.height) : (A.offset.x = w.x, A.offset.y = w.y + w.pY, w.y += d.pxToNumber(A.parent.style.height)), A.has.legend && A.has.panel && A.has.panel.style.marginTop ? (w.y += d.pxToNumber(A.has.panel.style.marginTop), A.offset.y += d.pxToNumber(A.has.panel.style.marginTop)) : d.setup.chart.legend && -1 != ["left", "right"].indexOf(d.setup.chart.legend.position) && (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left))), fabric.parseSVGDocument(A.svg, function (E) {
                        return function (I, P) {
                            var O, G = fabric.util.groupSVGElements(I, P), z = [],
                            ...
                            for (E.offset.absolute ? (U.top = void 0 === E.offset.bottom ? E.offset.top : w.height - E.offset.height - E.offset.bottom, U.left = void 0 === E.offset.right ? E.offset.left : w.width - E.offset.width - E.offset.right) : (U.top = E.offset.y, U.left = E.offset.x), O = 0; O < G.paths.length; O++) {
                                ...
                                if (G.paths[O]) {
                                    ...
                                    if (G.paths[O].fill instanceof Object) "radial" == G.paths[O].fill.type && -1 == ["pie", "gauge"].indexOf(d.setup.chart.type) && (G.paths[O].fill.coords.r2 = -1 * G.paths[O].fill.coords.r1, G.paths[O].fill.coords.r1 = 0, G.paths[O].set({opacity: G.paths[O].fillOpacity})); else if ((H = d.isHashbanged(G.paths[O].fill)) && E.patterns && E.patterns[H]) {
                                        var X = E.patterns[H];
                                        N.included++, fabric.Image.fromURL(X.source, function (Z, Q) {
                                            return function ($) {
                                                ...
                                                G.paths[Q].set({fill: te, opacity: G.paths[Q].fillOpacity})
                                            }
                                        }(X, O))
                                    }
                                        ...
                                        clipTo: function (Z, Q) {
                                            return function ($) {
                                                var ee = E.clippings[Q],
                                                    te = this.transformMatrix || [1, 0, 0, 1, 0, 0], ae = {
                                                        top: ee.bbox.y,
                                                        left: ee.bbox.x,
                                                        width: ee.bbox.width,
                            ...
                            if (G.paths = z, G.set(U), d.setup.fabric.add(G), E.svg.parentNode && E.svg.parentNode.getElementsByTagName) {
                                ...
                                for (O = 0; O < W.length; O++) if (h.balloonFunction instanceof Function) h.balloonFunction.apply(d, [W[O], E]); else {
                                    var _ = W[O], Y = fabric.parseStyleAttribute(_),
                            ...
                            if (E.svg.nextSibling && "A" == E.svg.nextSibling.tagName) {
                                var _ = E.svg.nextSibling, Y = fabric.parseStyleAttribute(_),
                                    J = new fabric.Text(_.innerText || _.textContent || _.innerHTML, {
                                        selectable: !1,
                                        top: d.pxToNumber(Y.top) + E.offset.y,
                                        left: d.pxToNumber(Y.left) + E.offset.x,
                            ...
                            if (m.pop(), !m.length) var q = +new Date, K = setInterval(function () {
                                var Z = +new Date;
                        ...
                        var P, O = d.gatherAttribute(E, "class"), B = d.gatherAttribute(E, "visibility"),
                            G = d.gatherAttribute(E, "clip-path");
                        I.className = O + "", I.classList = (O + "").split(" "), I.clipPath = G, I.svg = E;
                        var z = ["fill", "stroke"];
                        for (P = 0; P < z.length; P++) {
                            var U = z[P], H = (E.getAttribute(U) || "none") + "",
                                X = +(E.getAttribute(U + "-opacity") || "1"), W = d.getRGBA(H);
            ...
            toCanvas: function (c, u) {
                var f = d.deepMerge({}, c || {}), h = d.setup.canvas;
                return d.handleCallback(u, h, f), h
            },
            toImage: function (c, u) {
                var f = d.deepMerge({format: "png", quality: 1, multiplier: d.config.multiplier}, c || {}), h = f.data,
                    m = document.createElement("img");
                return !!d.handleNamespace("fabric", {
                    scope: this,
                    cb: d.toImage,
                    args: arguments
                }) && (f.data || (f.lossless || "svg" == f.format ? h = d.toSVG(d.deepMerge(f, {getBase64: !0})) : h = d.setup.fabric.toDataURL(f)), m.setAttribute("src", h), d.handleCallback(u, m, f), m)
            },
            toBlob: function (c, u) {
                var h, f = d.deepMerge({data: "empty", type: "text/plain"}, c || {}),
                    m = /^data:.+;base64,(.*)$/.exec(f.data);
                return m && (f.data = m[0], f.type = f.data.slice(5, f.data.indexOf(",") - 7), f.data = d.toByteArray({data: f.data.slice(f.data.indexOf(",") + 1, f.data.length)})), h = f.getByteArray ? f.data : new Blob([f.data], {type: f.type}), d.handleCallback(u, h, f), h
            },
            toJPG: function (c, u) {
                var f = d.deepMerge({format: "jpeg", quality: 1, multiplier: d.config.multiplier}, c || {});
            ...
            toPNG: function (c, u) {
                var h, f = d.deepMerge({format: "png", quality: 1, multiplier: d.config.multiplier}, c || {});
                return (/iP(hone|od|ad)/.test(navigator.platform) && (f.multiplier = 1), !!d.handleNamespace("fabric", {
                    scope: this,
                    cb: d.toPNG,
                    args: arguments
            ...
            toSVG: function (c, u) {
                var w, f = [], h = [], m = d.deepMerge({
                    compress: d.config.compress, reviver: function (T, A) {
                        var M = new RegExp(/\bstyle=(['"])(.*?)\1/), F = M.exec(T)[0].slice(7, -1), D = F.split(";"),
                            E = [];
                        for (i1 = 0; i1 < D.length; i1++) if (D[i1]) {
                            var I = D[i1].replace(/\s/g, "").split(":"), P = I[0], O = I[1];
                            if (-1 == ["fill", "stroke"].indexOf(P)) "opactiy" != P && E.push(D[i1]); else if (O = d.getRGBA(O, !0), O) {
                                var B = "#" + O.toHex(), G = O._source[3];
                                E.push([P, B].join(":")), E.push([P + "-opacity", G].join(":"))
                            } else E.push(D[i1])
                        }
                        if (T = T.replace(F, E.join(";")), A && A.svg) {
                            var z = A.svg.id, U = 2, H = T.slice(-U);
                            "/>" != H && (U = 3, H = T.slice(-U));
                            var X = T.slice(0, T.length - U), W = " clip-path=\"url(#" + z + ")\" ",
                ...
                if (w = d.setup.fabric.toSVG(m, m.reviver), f.length) {
                    var N = w.slice(0, w.length - 6), S = w.slice(-6);
                    w = N + f.join("") + S
                }
            ...
            toPDF: function (c, u) {
                ...
                if (m.images.reference = d.toPNG(m), !m.content) {
                    var N = [], S = h(m.pageSize, m.pageOrientation), T = f(m.pageMargins);
            ...
            toPRINT: function (c, u) {
                var f, h = d.deepMerge({delay: 1, lossless: !1}, c || {}), m = d.toImage(h), w = [],
                    N = document.body.childNodes, S = document.documentElement.scrollTop || document.body.scrollTop;
            ...
            toJSON: function (c, u) {
                var f = d.deepMerge({dateFormat: d.config.dateFormat || "dateObject"}, c || {}, !0), h = {};
            ...
            toCSV: function (c, u) {
                var m = d.deepMerge({delimiter: ",", quotes: !0, escape: !0, withHeader: !0}, c || {}, !0), w = [],
                    N = "";
            ...
            toXLSX: function (c, u) {
                function f(T, A) {
                    A && (T += 1462);
                    var M = Date.parse(T), F = 1e3 * (60 * T.getTimezoneOffset());
                ...
                return !!d.handleNamespace("XLSX", {
                    ...
                    for (var M = {}, F = {
                        s: {c: 1e7, r: 1e7},
                        e: {c: 0, r: 0}
                    }, D = 0; D != T.length; ++D) for (var E = 0; E != T[D].length; ++E) {
            ...
            toArray: function (c, u) {
                ...
                var w, N = d.deepMerge({withHeader: !1, stringify: !0, escape: !1, quotes: !1}, c || {}, !0), S = [],
                    T = [], A = [], M = d.config.processData;
                return N.processData = function (F, D) {
                    var E = D.exportFields || Object.keys(D.dataFieldsMap);
                    for (w = 0; w < E.length; w++) {
                        var I = E[w], P = D.dataFieldsTitlesMap[I];
                        T.push(P)
                    }
            ...
            toByteArray: function (c, u) {
                ...
                var m = d.deepMerge({}, c || {}), w = "undefined" == typeof Uint8Array ? Array : Uint8Array,
                    N = "+".charCodeAt(0), S = "/".charCodeAt(0), T = "0".charCodeAt(0), A = "a".charCodeAt(0),
                    M = "A".charCodeAt(0), F = function (D) {
                        function E(X) {
                            z[H++] = X
                        }
            ...
            handleNamespace: function (c, u) {
                ...
                var N, h = d.config.scope || window, m = !1, w = +new Date;
            ...
            handleBorder: function (c) {
                if (d.config.border instanceof Object) {
                    var u = d.deepMerge(d.defaults.fabric.border, c.border || {}, !0), f = new fabric.Rect;
            ...
            handleDropbox: function (c) {
                if (d.drawing.enabled) if (c.preventDefault(), c.stopPropagation(), "dragover" == c.type) d.setup.wrapper.setAttribute("class", d.setup.chart.classNamePrefix + "-export-canvas active dropbox"); else if (d.setup.wrapper.setAttribute("class", d.setup.chart.classNamePrefix + "-export-canvas active"), "drop" == c.type && c.dataTransfer.files.length) for (var f, u = 0; u < c.dataTransfer.files.length; u++) f = new FileReader, f.onloadend = function (h) {
                    return function () {
                        d.drawing.handler.add({url: f.result, top: c.layerY - 10 * h, left: c.layerX - 10 * h})
                    }
                }(u), f.readAsDataURL(c.dataTransfer.files[u])
            },
            handleReady: function (c) {
                var h = this, m = +new Date;
            ...
            getChartData: function (c) {
                ...
                if (0 == f.data.length) if ("stock" == d.setup.chart.type) {
                    ...
                    if (d.setup.chart.comparedGraphs.length) {
                        ...
                        for (m = 0; m < d.setup.chart.comparedGraphs.length; m++) {
                            ...
                            for (w = 0; w < F.dataSet.dataProvider.length; w++) {
                                var D = F.dataSet.categoryField, E = F.dataSet.dataProvider[w][D], I = T.indexOf(E);
                                if (-1 != I) for (N = 0; N < F.dataSet.fieldMappings.length; N++) {
                                    var A = F.dataSet.fieldMappings[N], h = F.dataSet.id + "_" + A.toField;
                    ...
                    for (m = 0; m < d.setup.chart.dataProvider.length; m++) {
                        ...
                        if (O[P]) for (w = 0; w < O[P].length; w++) O[P][w][d.setup.chart.categoryField] = O[d.setup.chart.categoryField], f.data.push(O[P][w])
                    }
                    for (m = 0; m < d.setup.chart.graphs.length; m++) {
                        var F = d.setup.chart.graphs[m];
                        for (w = 0; w < S.length; w++) {
                            var B = S[w], G = F[B], z = F.title;
                            u(G, F.title, B)
                        }
                    }
                } else if (-1 != ["pie", "funnel"].indexOf(d.setup.chart.type)) f.data = d.setup.chart.dataProvider, u(d.setup.chart.titleField), f.dateFields.push(d.setup.chart.titleField), u(d.setup.chart.valueField); else if ("map" != d.setup.chart.type) for (f.data = d.setup.chart.dataProvider, d.setup.chart.categoryAxis && (u(d.setup.chart.categoryField, d.setup.chart.categoryAxis.title), !1 !== d.setup.chart.categoryAxis.parseDates && f.dateFields.push(d.setup.chart.categoryField)), m = 0; m < d.setup.chart.graphs.length; m++) {
                    var F = d.setup.chart.graphs[m];
                    for (w = 0; w < S.length; w++) {
                        var B = S[w], G = F[B];
                        u(G, F.title, B)
            ...
            getAnnotations: function (c, u) {
                var h, f = d.deepMerge({}, c || {}, !0), m = [];
                for (h = 0; h < d.setup.fabric._objects.length; h++) if (!d.setup.fabric._objects[h].isCoreElement) {
                ...
                if (u.data.length) {
                    ...
                    for (f = 0; f < u.data.length; f++) {
                        ...
                        for (h = 0; h < u.dataFields.length; h++) {
                            var S = u.dataFields[h], T = u.dataFieldsMap[S],
                                A = u.columnNames && u.columnNames[S] || u.titles[S] || S, M = u.data[f][T];
            ...
            createMenu: function (c, u) {
                function f(w, N) {
                    ...
                    for (S = 0; S < w.length; S++) {
                        var M = "string" == typeof w[S] ? {format: w[S]} : w[S], F = document.createElement("li"),
                            D = document.createElement("a"), E = document.createElement("img"),
                        ...
                        }, M) : !M.label && (M.label = M.label ? M.label : d.i18l("menu.label." + P)), -1 != ["CSV", "JSON", "XLSX"].indexOf(M.format) && -1 != ["map", "gauge"].indexOf(d.setup.chart.type)) continue; else if (!d.setup.hasBlob && "UNDEFINED" != M.format && M.mimeType && "image" != M.mimeType.split("/")[0] && "text/plain" != M.mimeType) continue;
                        ...
                        }(M)) : M.menu = []; else if (!M.populated && M.action && -1 != M.action.indexOf("draw.")) {
                            var O = M.action.split(".")[1], B = M[O] || d.config.fabric.drawing[O] || [];
                            for (M.menu = [], M.populated = !0, T = 0; T < B.length; T++) {
                                var G = {label: B[T]};
                                if ("shapes" == O) {
                                    var z = -1 == B[T].indexOf("//"), U = (z ? d.config.path + "shapes/" : "") + B[T];
                        ...
                        (void 0 === M.menu || M.menu.length) && (D.setAttribute("href", "#"), d.setup.hasTouch && F.classList ? (D.addEventListener("touchend", function (H, X) {
                            ...
                            return function (X) {
                                ...
                                X.preventDefault();
                                var J = H.elements.li, q = function (te) {
                                    var ae = te.parentNode.parentNode, ie = ae.classList;
                                    return "LI" == ae.tagName && ie.contains("active")
                                }(J), K = function (te) {
                                    var ae = te.parentNode.children;
                                    for (S = 0; S < ae.length; S++) {
                                        var ie = ae[S], re = ie.classList;
                                ...
                                if ((V(J) || !Z) && d.setup.menu.classList.toggle("active"), !q || !Z) for (; m.length;) {
                                    var Q = m.pop(), $ = V(Q);
            ...
            delay: function (c, u) {
                var h, m, f = d.deepMerge({delay: 3, precision: 2}, c || {}), w = +new Date, N = d.createMenu([{
            ...
            migrateSetup: function (c) {
                ...
                var f = {enabled: !0, migrated: !0, libs: {autoLoad: !0}, menu: []};
                return u(c), f
            },
            clear: function () {
                var c, u;
            ...
            loadListeners: function () {
                function c(u) {
                    u && (u.set({top: u.top + 10, left: u.left + 10}), d.setup.fabric.add(u))
                }
                ...
                d.config.keyListener && "attached" != d.config.keyListener && (d.docListener = function (u) {
                    ...
                    var T = d.drawing.buffer.target, M = -1 != ["top-left", "bottom-left"].indexOf(d.config.position),
        ...
        if (r) d.config = r; else if (d.setup.chart[d.name]) d.config = d.setup.chart[d.name]; else if (d.setup.chart.amExport || d.setup.chart.exportConfig) d.config = d.migrateSetup(d.setup.chart.amExport || d.setup.chart.exportConfig); else return;
